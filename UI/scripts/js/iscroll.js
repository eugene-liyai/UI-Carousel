...
function createDefaultScrollbar (direction, interactive, type) {
	...
	if ( type === true ) {
		...
		indicator.style.cssText = 'position:absolute;background:white;-webkit-border-radius:20px;-moz-border-radius:20px;border-radius:20px;';
	}
	...
	if ( direction == 'h' ) {
		...
		if ( type === true ) {
			scrollbar.style.cssText += 'width:7px;bottom:10px;top:10px;right:10px;background:rgba(0,0,0,.2);-webkit-border-radius:20px;-moz-border-radius:20px;border-radius:20px;';
